...
namespace GUI
{
    public partial class Form1 : Form
    {
        ...
        {
           //menerima data yang dikirimkan secara serial
        ...
        private void UpdateStateUI()
        {
            switch (State_GUI)
            {
                ...
                case 8: 
                    ...
                    Graph_D1.Text = "Lidar Kiri";
                    Label_D1.Text = "Lidar Kiri :";
                    Graph_D2.Text = "Lidar Kanan Belakang";
                    Label_D2.Text = "Lidar Kanan Belakang";
                ...
                case 10:
                    ...
                    tBoxState.Text = Graph_State_GUI.Text;
                    Graph_D1.Text = "Deteksi Tembok Tanpa Derorr";
        ...
        private void UpdateTextBoxes(string[] data_GUI)
        {
            ...
            if (data_GUI.Length > 5) textBoxD5.Text = data_GUI[7];
        }
